...
std::string COSDParam::_param_serialize(uint8_t *buf, int32_t addr, const std::string &paramname)
{
    std::string strret = "";
    ...
    try{
        ...
        if((paramname.find("_Panel") != std::string::npos) &&
           (paramname.find("PWM") == std::string::npos)    &&
           (paramname.find("Max_Panels") == std::string::npos)){
            realvalue = _get_u16_param(buf, addr);
            if(realvalue == 0){
                strret = "0";
            }
            else if(realvalue == 1){
        ...
        if((paramname.find("Attitude_") != std::string::npos) &&
           (paramname.find("_Scale") != std::string::npos)){
            realvalue = _get_u16_param(buf, addr);
            uint16_t fracvalue = _get_u16_param(buf, addr+2);
...
void COSDParam::_init_params()
{
    ...
    _set_params_default("HomeDistance_H_Alignment",address, 0); address += 2;

    _set_params_default("WPDistance_Enable",address, 1); address += 2;
    _set_params_default("WPDistance_Panel",address, 1); address += 2;
    _set_params_default("WPDistance_H_Position",address, 70); address += 2;
    _set_params_default("WPDistance_V_Position",address, 24); address += 2;
    _set_params_default("WPDistance_Font_Size",address, 0); address += 2;
    _set_params_default("WPDistance_H_Alignment",address, 0); address += 2;

    _set_params_default("CHWDIR_Tmode_Enable",address, 1); address += 2;
    _set_params_default("CHWDIR_Tmode_Panel",address, 2); address += 2;
    _set_params_default("CHWDIR_Tmode_V_Position",address, 15); address += 2;
    _set_params_default("CHWDIR_Nmode_Enable",address, 1); address += 2;
    _set_params_default("CHWDIR_Nmode_Panel",address, 1); address += 2;
    _set_params_default("CHWDIR_Nmode_H_Position",address, 30); address += 2;
    _set_params_default("CHWDIR_Nmode_V_Position",address, 35); address += 2;
    _set_params_default("CHWDIR_Nmode_Radius",address, 20); address += 2;
    _set_params_default("CHWDIR_Nmode_Home_Radius",address, 25); address += 2;
    _set_params_default("CHWDIR_Nmode_WP_Radius",address, 25); address += 2;

    _set_params_default("Attitude_MP_Enable",address, 1); address += 2;
    _set_params_default("Attitude_MP_Panel",address, 1); address += 2;
    _set_params_default("Attitude_MP_Mode",address, 0); address += 2;
    _set_params_default("Attitude_3D_Enable",address, 1); address += 2;
    _set_params_default("Attitude_3D_Panel",address, 2); address += 2;

    _set_params_default("Misc_Units_Mode",address, 0); address += 2;
    _set_params_default("Misc_Max_Panels",address, 3); address += 2;

    _set_params_default("PWM_Video_Enable",address, 1); address += 2;
    _set_params_default("PWM_Video_Chanel",address, 6); address += 2;
    _set_params_default("PWM_Video_Value",address, 1200); address += 2;
    _set_params_default("PWM_Panel_Enable",address, 1); address += 2;
    _set_params_default("PWM_Panel_Chanel",address, 7); address += 2;
    _set_params_default("PWM_Panel_Value",address, 1200); address += 2;

    _set_params_default("Alarm_H_Position",address, 180); address += 2;
    _set_params_default("Alarm_V_Position",address, 25); address += 2;
    _set_params_default("Alarm_Font_Size",address, 1); address += 2;
    _set_params_default("Alarm_H_Alignment",address, 1); address += 2;
    _set_params_default("Alarm_GPS_Status_Enable",address, 1); address += 2;
    _set_params_default("Alarm_Low_Batt_Enable",address, 1); address += 2;
    _set_params_default("Alarm_Low_Batt",address, 20); address += 2;
    _set_params_default("Alarm_Under_Speed_Enable",address, 0); address += 2;
    _set_params_default("Alarm_Under_Speed",address, 2); address += 2;
    _set_params_default("Alarm_Over_Speed_Enable",address, 0); address += 2;
    _set_params_default("Alarm_Over_Speed",address, 100); address += 2;
    _set_params_default("Alarm_Under_Alt_Enable",address, 0); address += 2;
    _set_params_default("Alarm_Under_Alt",address, 10); address += 2;
    _set_params_default("Alarm_Over_Alt_Enable",address, 0); address += 2;
    _set_params_default("Alarm_Over_Alt",address, 1000); address += 2;

    _set_params_default("ClimbRate_Enable",address, 1); address += 2;
    _set_params_default("ClimbRate_Panel",address, 1); address += 2;
    _set_params_default("ClimbRate_H_Position",address, 5); address += 2;
    _set_params_default("ClimbRate_V_Position",address, 220); address += 2;
    _set_params_default("ClimbRate_Font_Size",address, 0); address += 2;

    _set_params_default("RSSI_Enable",address, 0); address += 2;
    _set_params_default("RSSI_Panel",address, 1); address += 2;
    _set_params_default("RSSI_H_Position",address, 70); address += 2;
    _set_params_default("RSSI_V_Position",address, 220); address += 2;
    _set_params_default("RSSI_Font_Size",address, 0); address += 2;
    _set_params_default("RSSI_H_Alignment",address, 0); address += 2;
    _set_params_default("RSSI_Min",address, 0); address += 2;
    ...
    _set_params_default("Wind_H_Position",address, 10); address += 2;
    _set_params_default("Wind_V_Position",address, 100); address += 2;

    _set_params_default("Time_Type",address, 0); address += 2;

    _set_params_default("Throttle_Scale_Type",address, 0); address += 2;

    _set_params_default("Attitude_MP_H_Position",address, 180); address += 2;
    _set_params_default("Attitude_MP_V_Position",address, 133); address += 2;
    _set_params_default("Attitude_MP_Scale_Real",address, 1); address += 2;
    _set_params_default("Attitude_MP_Scale_Frac",address, 0); address += 2;
    _set_params_default("Attitude_3D_H_Position",address, 180); address += 2;
    _set_params_default("Attitude_3D_V_Position",address, 133); address += 2;
    _set_params_default("Attitude_3D_Scale_Real",address, 1); address += 2;
    _set_params_default("Attitude_3D_Scale_Frac",address, 0); address += 2;
    _set_params_default("Attitude_3D_Map_radius",address, 40); address += 2;
    ...
    _set_params_default("Speed_Scale_V_Position",address, 133); address += 2;
    _set_params_default("Altitude_Scale_V_Position",address, 133); address += 2;

    _set_params_default("BatteryConsumed_Enable",address, 1); address += 2;
    _set_params_default("BatteryConsumed_Panel",address, 1); address += 2;
    _set_params_default("BatteryConsumed_H_Position",address, 350); address += 2;
    _set_params_default("BatteryConsumed_V_Position",address, 34); address += 2;
    _set_params_default("BatteryConsumed_Font_Size",address, 0); address += 2;
    _set_params_default("BatteryConsumed_H_Alignment",address, 2); address += 2;

    _set_params_default("TotalTrip_Enable",address, 1); address += 2;
    _set_params_default("TotalTrip_Panel",address, 1); address += 2;
    _set_params_default("TotalTrip_H_Position",address, 350); address += 2;
    _set_params_default("TotalTrip_V_Position",address, 210); address += 2;
    _set_params_default("TotalTrip_Font_Size",address, 0); address += 2;
    _set_params_default("TotalTrip_H_Alignment",address, 2); address += 2;

    _set_params_default("RSSI_Type",address, 0); address += 2;

    _set_params_default("Map_Enable",address, 1); address += 2;
    _set_params_default("Map_Panel",address, 4); address += 2;
    _set_params_default("Map_Radius",address, 120); address += 2;
    _set_params_default("Map_Font_Size",address, 1); address += 2;
    _set_params_default("Map_H_Alignment",address, 0); address += 2;
    _set_params_default("Map_V_Alignment",address, 0); address += 2;

    _set_params_default("Altitude_Relative_Enable",address, 1); address += 2;
    _set_params_default("Altitude_Relative_Panel",address, 2); address += 2;
    _set_params_default("Altitude_Relative_H_Position",address, 5); address += 2;
    _set_params_default("Altitude_Relative_V_Position",address, 25); address += 2;
    _set_params_default("Altitude_Relative_Font_Size",address, 0); address += 2;
    _set_params_default("Altitude_Relative_H_Alignment",address, 0); address += 2;

    //0:absolute altitude 1:relative altitude
    _set_params_default("Altitude_Scale_Type",address, 1); address += 2;

    _set_params_default("Speed_Air_Enable",address, 1); address += 2;
    _set_params_default("Speed_Air_Panel",address, 2); address += 2;
    _set_params_default("Speed_Air_H_Position",address, 5); address += 2;
    _set_params_default("Speed_Air_V_Position",address, 55); address += 2;
    _set_params_default("Speed_Air_Font_Size",address, 0); address += 2;
    _set_params_default("Speed_Air_H_Alignment",address, 0); address += 2;

    //0:ground speed 1:air speed
    _set_params_default("Speed_Scale_Type",address, 0); address += 2;

    // sign of start col. 1:positive 0:negative
    _set_params_default("Misc_Start_Col_Sign",address, 1); address += 2;
